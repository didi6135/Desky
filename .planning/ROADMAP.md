...
- [x] **Phase 1: Rebrand** - Claudify → Desky across paths, service unit, registry, URLs, validators, plus a one-shot host migration helper
...
- [x] 01-03: README accurate refresh (Desky brand + real multi-instance layout + `didi6135/Desky` URLs); deep docs rewrite stays in Phase 3
...
|-------|-----------|----------------|--------|-----------|
| 1. Rebrand | v1.0 | 3/3 | Complete | 2026-05-27 |
